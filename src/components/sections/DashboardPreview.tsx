    ...
    <section className="py-24 bg-background relative border-y border-border/30">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-6">Developer-First Dashboard</h2>
          ...
          <div className="rounded-xl border border-border/50 bg-[#0d0d12] shadow-2xl overflow-hidden flex flex-col md:flex-row">
            <div className="w-full md:w-64 border-r border-border/50 bg-black/40 p-4 flex flex-col gap-2">
              <div className="flex items-center gap-2 px-2 py-3 mb-4">
                ...
                <span className="font-semibold text-foreground">NexusProxy</span>
              </div>
              <div className="px-3 py-2 rounded-md bg-primary/10 text-primary text-sm font-medium flex items-center gap-3">
                <Activity className="w-4 h-4" /> Overview
              </div>
              <div className="px-3 py-2 rounded-md text-muted-foreground hover:text-foreground hover:bg-white/5 text-sm font-medium flex items-center gap-3 cursor-pointer transition-colors">
            ...
            <div className="flex-1 p-6 md:p-8 bg-[#0d0d12]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div className="bg-black/40 border border-border/50 rounded-lg p-4">
                  ...
                  <div className="text-2xl font-bold text-foreground">12.4 <span className="text-sm font-normal text-muted-foreground">GB / 20 GB</span></div>
                ...
                <div className="bg-black/40 border border-border/50 rounded-lg p-4">
                  ...
                  <div className="text-2xl font-bold text-foreground">Business</div>
