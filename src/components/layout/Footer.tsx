    ...
    <footer className="border-t border-border bg-background">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground">
              Crypto-native proxy infrastructure for scrapers, automation, and privacy-first teams.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="#" className="hover:text-foreground transition-colors">Acceptable Use</a></li>
            </ul>
          </div>
        </div>
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
          <span>© {new Date().getFullYear()} NexusProxy. All rights reserved.</span>
          <span>No KYC · No logs · Crypto-only</span>
        </div>
      </div>
    </footer>
  );
